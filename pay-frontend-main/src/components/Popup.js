    ...
    >
      ...
      >
        ...
        <button
          ...
          className="absolute top-[-1.5rem] right-[-1.5rem] mt-2 mr-2 bg-gradient-to-r text-white from-newStart via-newMid to-newEnd rounded-full p-2"
        >
          <img src="../images/icons/close.png" className="w-8" alt="Close" />
        </button>
      </div>
    </div>
  );
