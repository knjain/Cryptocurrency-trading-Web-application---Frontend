...
import { updateWithdrawalWallet } from "../../../../services/walletService";
import { sendOTP } from "../../../../services/userService";
import { FiLoader } from "react-icons/fi";
import toast from "react-hot-toast";

const WithdrawalWalletModel = ({ handleClose }) => {
  ...
  const handleUpdate = async () => {
    setIsLoading(true);
    try {
      const response = await updateWithdrawalWallet(modalForm);
      ...
      {!isOTPSent ? (
        <div className="max-w-[450px] rounded-2xl bg-[#0a090d] p-6 max-h-[280px] relative">
          ...
          <h4 className="font-medium mb-6">
            Please enter your Withdrawal Wallet Address <br />(
...
export default WithdrawalWalletModel;
